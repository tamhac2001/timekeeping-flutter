...
class _$ServerError with DiagnosticableTreeMixin implements ServerError {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'EmployeeFailure.serverError()';
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'EmployeeFailure.serverError'));
  }
...
class _$NoEmployeeFound
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'EmployeeFailure.noEmployeeFound()';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
        .add(DiagnosticsProperty('type', 'EmployeeFailure.noEmployeeFound'));
  }
